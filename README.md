...
Projekt wymaga biblioteki SFML w wersji 3.0.2. Pobierz wersję 64-bit stąd: https://www.sfml-dev.org/download/sfml/3.0.2/
...
Aby gra się uruchomiła, pliki bibliotek muszą znajdować się w tym samym folderze co plik .exe. Skopiuj wszystkie pliki z rozszerzeniem .dll z folderu SFML/bin do folderu wyjściowego projektu:
