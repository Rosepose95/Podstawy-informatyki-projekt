...
sf::Texture Enemy::texNormal;
sf::Texture Enemy::texFast;
sf::Texture Enemy::texTank;
sf::Texture Enemy::texBoss;

void Enemy::loadTextures() {
    
    texNormal.loadFromFile("assets/robal_normal.png");
    texFast.loadFromFile("assets/robal_fast.png");
    texTank.loadFromFile("assets/robal_tank.png");
    texBoss.loadFromFile("assets/robal_boss.png");
}
static const sf::Texture& getTextureForType(EnemyType type)
{
    switch (type) {
    case EnemyType::Normal: return Enemy::texNormal;
    case EnemyType::Fast:   return Enemy::texFast;
    case EnemyType::Tank:   return Enemy::texTank;
    case EnemyType::Boss:   return Enemy::texBoss;
    default:                return Enemy::texNormal;
    }
}
...
Enemy::Enemy(int h, float startX, float startY, EnemyType t)
    ...
    , map(nullptr)
    , speed(100.f)
    , sprite(getTextureForType(t))  // <<< KLUCZOWE
{
...
void Enemy::update(float dt) {
    ...
    sprite.setRotation(sf::degrees(angle + 90.f)); // +90 jeśli sprite "patrzy w górę"
    sprite.setPosition(shape.getPosition());
}
